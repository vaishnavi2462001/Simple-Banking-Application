...
public class TransactionService {
	...
	public void withdraw(String accountNumber, BigDecimal amount)
			...
			transrepo.save(new Transaction(TransactionType.WITHDRAWAL, accountNumber,amount, LocalDateTime.now(),account));
	}
	...
	public void transfer(Account fromAccount, Account toAccount, BigDecimal amount)
			...
			transrepo.save(new Transaction(TransactionType.TRANSFER, fromaccount.getAccountNumber(), amount.negate(), LocalDateTime.now(), toaccount));
	        transrepo.save(new Transaction(TransactionType.TRANSFER, toaccount.getAccountNumber(), amount, LocalDateTime.now(), fromaccount));
	}
}
