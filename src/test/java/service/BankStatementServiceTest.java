...
public class BankStatementServiceTest {
	...
	public void checkStatement() {
		...
		Transaction transaction = new Transaction(TransactionType.DEPOSIT, account.getAccountNumber(),
				new BigDecimal("300.70"), LocalDateTime.now(), account);
		transrepo.save(transaction);

		List<Transaction> tlist = bankservice.getStatements(account.getAccountNumber(),
