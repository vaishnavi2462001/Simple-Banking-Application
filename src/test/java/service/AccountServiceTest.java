...
public class AccountServiceTest {
	...
	public void classSetup() {
	    // Run once for all tests, e.g., initialize repositories or services
	...
	public void addAccount() throws DuplicateAccountException {
        ...
        Assert.assertEquals(accountrepo.findByAccountNumber(account.getAccountNumber()),account,"Account is not added successfully");
	}
	...
	public void getAllAccounts() throws DuplicateAccountException {
		accountservice.addAccount(new Account(data.getCustomerId(), new BigDecimal("808.00"), Account.AccountType.SAVINGS));
        accountservice.addAccount(new Account(data.getCustomerId(), new BigDecimal("977.00"), Account.AccountType.CHECKING));
