...
public class AccountRepositoryTest {
	...
	public void setup() {
		...
		accountrepo.clear();// makes sure repo gets cleared before every test so that it does not save prev
							// accounts and while runninf findall test case, it does not match list size
	...
	public void checkDeletion() {
		...
		Assert.assertNull(accountrepo.findByAccountNumber(account.getAccountNumber()),
